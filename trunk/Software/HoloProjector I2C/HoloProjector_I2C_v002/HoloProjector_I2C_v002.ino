...
// v002 - Adjustable HP Servo EndPoints
...
void setup() {
  ...
  if (HP==1) {Wire.begin(25);twitchLEDTime = 1000;twitchHPTime=2500;blueON(2);} // Start I2C Bus as Master I2C Address 25 (Assigned FHP)
  if (HP==2) {Wire.begin(26);twitchLEDTime = 2300;twitchHPTime=1750;redON(2);}  // Start I2C Bus as Master I2C Address 26 (Assigned THP)
  if (HP==3) {Wire.begin(27);twitchLEDTime = 1900;twitchHPTime=4500;greenON(2);}// Start I2C Bus as Master I2C Address 27 (Assigned RHP)
...
void twitchHP(){
 hp1servo.write(random(lowHP1,highHP1));
 hp2servo.write(random(lowHP2,highHP2));
 delay(500);
}

void centerHP(){
  hp1servo.write(centerHP1);
  hp2servo.write(centerHP2);
  delay(500);          // wait for a .5 secs for the servos to move
}

void lookdownHP(){
  hp1servo.write(downHP1);
  hp2servo.write(downHP2);
  delay(500);          // wait for a .5 secs for the servos to move
}
